...
const Hero = () => {
  return (
    <div className=" dark:text-white duration-300 clip-right-diagonal bg-[url('assets/website/catholic.jpeg')] bg-cover ">
      <div className="container min-h-[620px] flex mt-10 sm:mt-0">
        <div className="flex items-center justify-center">
          ...
          <div className="space-y-5 order-2 sm:order-1 xl:pr-40 flex flex-col items-center justify-center ">
            ...
            >
              Play{" "}
              <span className=" text-white">with us to enroll in Heaven</span>
            </h1>
